...
export const HelpBox: React.FC = () => {
  ...
  const customerRoles: string[] = ['Citizen Reporter'];
  const tenantRoles: string[] = ['Constituency Coordinator', 'Party Chief', 'Data Analyst', 'Field Volunteer'];
  const addOns: string[] = ['chat', 'file', 'notifications'];
  const applicationName = `JANAVAANI JANASENA`;
  const tenantName = `Jana Sena`;
